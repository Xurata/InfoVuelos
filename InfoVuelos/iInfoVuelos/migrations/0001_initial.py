...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'iInfoVuelos_company_airport', (
        ...
        db.create_unique(u'iInfoVuelos_company_airport', ['company_id', 'airport_id'])
        ...
        db.create_table(u'iInfoVuelos_flight', (
            ...
            ('airport', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['iInfoVuelos.Airport'], unique=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table('iInfoVuelos_company_airport')
    ...
    models = {
        ...
        u'iInfoVuelos.flight': {
            ...
            'airport': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['iInfoVuelos.Airport']", 'unique': 'True'}),
